          ...
          <div className="film-card__info">
            ...
            <div className="film-card__desc">
              ...
              <div className="film-rating">
                <div className="film-rating__score">{filmOnPage?.rating}</div>
                <p className="film-rating__meta">
                  <span className="film-rating__level">Very good</span>
                  <span className="film-rating__count">{filmOnPage?.scoresCount} ratings</span>
                </p>
              </div>

              <div className="film-card__text">
                <p>{filmOnPage?.description}</p>

                <p className="film-card__director"><strong>Director: {filmOnPage?.director}</strong></p>

                <p className="film-card__starring"><strong>Starring: {filmOnPage?.starring.join(', ')} and other</strong></p>
              </div>
            </div>
          </div>
        </div>
